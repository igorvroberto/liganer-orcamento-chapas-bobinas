...
No navegador, o app busca `/bobinas-chapas/precos-bobinas-chapas.xlsx` ao abrir. Também é possível trocar só esse arquivo no HostGator (FTP) e dar hard-refresh, sem rebuild — desde que o cabeçalho/colunas permaneçam iguais.
